...
export default function Loader({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "bg-brand dark:bg-white rounded-full",
      ...
      <span
        className={cn(
          "animation-delay-200 bg-brand dark:bg-white rounded-full",
          handleVariantClasses(variant, size),
          sizes[size]
        )}
      />
      <span
        className={cn(
          "animation-delay-500 bg-brand dark:bg-white rounded-full",
          handleVariantClasses(variant, size),
          sizes[size]
        )}
      />
      {variant === "moveUp" && !showOnlyThreeDots ? (
        <span
          className={cn(
            "animation-delay-700 bg-brand dark:bg-white rounded-full",
            handleVariantClasses(variant, size),
            sizes[size]
          )}
        />
