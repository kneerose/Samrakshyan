export const birdDetails = [
...

  {
    ...
    imageUrl:
      "https://drive.google.com/uc?export=view&id=1YvDYmK2b8FMsz9jmX3lRzRxqhDpp-neK",
    ...
    audioUrl:
      "https://drive.google.com/uc?export=view&id=1TH4Cc6G_koVH5HoXtd2VfRphaOVczFnN",
    id: "7deb9b6d-9549-43e3-b7ee-a354680c9dd4",
  },
  {
    name: "Spotted Dove",
    imageUrl:
      "https://drive.google.com/uc?export=view&id=1nLRrsoDs-TeQF0ly3hsvsXP-SLJ45C1C",
   ...
   \n &nbsp; \nThe Indian Spotted Dove is a social bird, and is known to form strong pair bonds with its mate. The male is known to perform courtship displays to attract a mate, which involve bowing and cooing. Breeding takes place between June and August, and the female typically lays two white eggs. The young hatch after approximately 14 days`,
    audioUrl:
      "https://drive.google.com/uc?export=view&id=1x-Ffem6S5PBcwKQnmrXf1JPdSTQ5CWZt",
    id: "7deb9b6d-9549-43e3-b7ee-a354680c9dd5",
  },
  {
    name: "Swamp Francolin",
    imageUrl:
      "https://drive.google.com/uc?export=view&id=1NMJ13zkNR4CC0Xn2vYajfQ6NMe-L1yCt",
