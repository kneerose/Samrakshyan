(() => {
  ...
  exports.modules = {
    ...
    /***/ 8185: /***/ (
      ...
      /* harmony import */ var next_config__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(4558);
      /* harmony import */ var next_config__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          next_config__WEBPACK_IMPORTED_MODULE_0__
        );
    ...
    /***/ 4437: /***/ (
      ...
      var router_default = /*#__PURE__*/ __webpack_require__.n(router_); // CONCATENATED MODULE: external "nprogress"
      const external_nprogress_namespaceObject = require("nprogress");
      var external_nprogress_default = /*#__PURE__*/ __webpack_require__.n(
        external_nprogress_namespaceObject
      );
      // EXTERNAL MODULE: external "react-redux"
      var external_react_redux_ = __webpack_require__(6022);
      // EXTERNAL MODULE: external "@reduxjs/toolkit"
      var toolkit_ = __webpack_require__(5184); // CONCATENATED MODULE: external "@reduxjs/toolkit/query"
      const query_namespaceObject = require("@reduxjs/toolkit/query"); // CONCATENATED MODULE: ./src/store/actions/resetState.ts
      const RESET_STATE_ACTION_TYPE = "resetState";
      const resetStateAction = (0, toolkit_.createAction)(
      ...
      const external_redux_logger_namespaceObject = require("redux-logger"); // CONCATENATED MODULE: ./src/store/enchancers.ts
      ...
      var bird_api = __webpack_require__(3290);
      // EXTERNAL MODULE: ./src/store/bird/birdSlice.ts
      var birdSlice = __webpack_require__(8883); // CONCATENATED MODULE: ./src/store/store.ts
      const loggerMiddleware = (0,
      external_redux_logger_namespaceObject.createLogger)();
      const middlewares = [
        loggerMiddleware,
      ...
      const reducers = {
        [api /* responseApi.reducerPath */.pC.reducerPath]:
          api /* responseApi.reducer */.pC.reducer,
        [bird_api /* birdApi.reducerPath */.S5.reducerPath]:
          bird_api /* birdApi.reducer */.S5.reducer,
        [birdSlice /* default.reducerPath */.Z.reducerPath]:
          birdSlice /* default.reducer */.Z.reducer,
      };
      ...
      (0, query_namespaceObject.setupListeners)(store.dispatch); // CONCATENATED MODULE: external "next/head"

      const head_namespaceObject = require("next/head");
      var head_default =
        /*#__PURE__*/ __webpack_require__.n(head_namespaceObject); // CONCATENATED MODULE: external "styled-jsx/style"
      const style_namespaceObject = require("styled-jsx/style");
      var style_default = /*#__PURE__*/ __webpack_require__.n(
        style_namespaceObject
      );
      // EXTERNAL MODULE: external "react"
      var external_react_ = __webpack_require__(6689);
      var external_react_default =
        /*#__PURE__*/ __webpack_require__.n(external_react_); // CONCATENATED MODULE: ./src/components/ui/nprocess.tsx
      external_nprogress_default().configure({
        showSpinner: false,
      });
      /* eslint-disable react/prefer-stateless-function */ class NextNProgress extends external_react_default()
        .Component {
        static defaultProps = {
          color: "#29D",
          startPosition: 0.3,
      ...
      /* harmony default export */ const nprocess = NextNProgress; // CONCATENATED MODULE: ./src/pages/_app.tsx
    ...
    /***/ 895: /***/ (
      ...
      var react_ = __webpack_require__(4335);
      // EXTERNAL MODULE: ./src/configs/apiRoutes.ts
      var apiRoutes = __webpack_require__(717);
      // EXTERNAL MODULE: ./src/configs/environments.ts
      var environments = __webpack_require__(8185); // CONCATENATED MODULE: ./src/store/detail/types.ts
      const PREDICTION_RESPONSE_REDUCER_KEY = "responseApi"; // CONCATENATED MODULE: ./src/store/detail/api.ts
  ...
  var __webpack_exports__ = __webpack_require__.X(0, [436], () =>
    __webpack_exec__(4437)
  );
